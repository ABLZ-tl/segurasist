...
locals {
  ...
  public_cidrs = {
    "mx-central-1a" = "10.20.0.0/24"
    "mx-central-1b" = "10.20.1.0/24"
    "mx-central-1c" = "10.20.2.0/24"
  }

  private_app_cidrs = {
    "mx-central-1a" = "10.20.10.0/24"
    "mx-central-1b" = "10.20.11.0/24"
    "mx-central-1c" = "10.20.12.0/24"
  }

  private_data_cidrs = {
    "mx-central-1a" = "10.20.20.0/24"
    "mx-central-1b" = "10.20.21.0/24"
    "mx-central-1c" = "10.20.22.0/24"
  }
...
module "vpc" {
  ...
  enable_nat_high_availability = true # mirrors prod
...
############################################
# RDS (multi-AZ ON, no cross-region replica in staging)
############################################
...
module "amplify_admin" {
  ...
  branches = {
    "staging" = { stage = "BETA", framework = "Next.js - SSR" }
  }
